...
class ThumbnailLinkService
{
     ...
     */
    public static function getVideo(int $id): ?string
    {
     ...
     * @throws FilesystemException
     */
    public static function getFolder(int $id): ?string
    {
    ...
    public static function getImageStorage(int $id, ThumbnailInterface $thumbnail = null): ?string
    {
    ...
    public static function getDocument(int $id): ?string
    {
        $storage = Storage::get('thumbnail');
